...
const styles = StyleSheet.create({
  ...
  errorText: { fontSize: 15, color: '#EF4444', textAlign: 'center', fontFamily: fonts.bodyLight },
  ...
  countText: { fontSize: 12.8, fontFamily: fonts.bodyBold, color: theme.primary },
  sectionSub: { fontSize: 12.8, color: theme.textMuted, marginBottom: 14, lineHeight: 18, fontFamily: fonts.bodyLight },
  emptyBox: { alignItems: 'center', paddingVertical: 48, gap: 12 },
  emptyEmoji: { fontSize: 48 },
  emptyText: { fontSize: 15, color: theme.textMuted, textAlign: 'center', lineHeight: 22, paddingHorizontal: 32, fontFamily: fonts.bodyLight },
  ...
  intentText: { fontSize: 11.8, color: '#A78BFA', fontFamily: fonts.bodyBold },
  cardMeta: { fontSize: 12.8, color: theme.textSecondary, lineHeight: 18, fontFamily: fonts.bodyLight },
  ...
  levelLabel: { fontSize: 12.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
  ...
  actionedText: { fontSize: 13.9, color: theme.primary, fontFamily: fonts.bodyBold },
  ...
  inviteText: { fontSize: 12.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
  ...
  inviteBtnText: { color: theme.primary, fontSize: 13.9, fontFamily: fonts.bodyBold },
  invitedText: { fontSize: 13.9, color: theme.primary, fontFamily: fonts.bodyBold },
  ...
  statText: { fontSize: 12.8, color: theme.textSecondary, flex: 1, fontFamily: fonts.bodyLight },
  ...
  serveBtnText: { color: theme.primary, fontSize: 15, fontFamily: fonts.bodyBold },
  ...
  comingSoonText: { fontSize: 15, color: theme.textMuted, textAlign: 'center', lineHeight: 22, fontFamily: fonts.bodyLight },
});
