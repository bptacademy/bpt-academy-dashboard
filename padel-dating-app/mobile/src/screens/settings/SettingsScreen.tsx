...
const styles = StyleSheet.create({
  ...
  rowLabel: { fontSize: 16.1, color: theme.textPrimary, fontFamily: fonts.bodyLight },
  rowSub: { fontSize: 12.8, color: theme.textMuted, marginTop: 2, fontFamily: fonts.bodyLight },
