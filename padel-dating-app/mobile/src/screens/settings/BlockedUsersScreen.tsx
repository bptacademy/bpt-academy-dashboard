...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 19.3, fontFamily: fonts.bodyBold, color: theme.textPrimary },
  emptySub: { fontSize: 15, color: theme.textMuted, textAlign: 'center', lineHeight: 22, fontFamily: fonts.bodyLight, paddingHorizontal: 24 },
  row: {
  ...
  avatarInitials: { fontSize: 17.1, fontFamily: fonts.bodyBold, color: theme.primary },
  name: { flex: 1, fontSize: 16.1, fontFamily: fonts.bodyBold, color: theme.textPrimary },
  unblockBtn: {
    paddingHorizontal: 14, paddingVertical: 7, borderRadius: 10,
    backgroundColor: theme.bgDeep, borderWidth: 1, borderColor: theme.border,
  },
  unblockText: { fontSize: 13.9, color: theme.textSecondary, fontFamily: fonts.bodyBold },
});
