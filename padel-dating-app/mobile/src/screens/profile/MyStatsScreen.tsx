...
const styles = StyleSheet.create({
  ...
  syncBtnText: { color: theme.primary, fontSize: 16.1, fontFamily: fonts.bodyBold },
  scroll: { padding: 16 },
  levelCard: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
  ...
  levelLabel: { fontSize: 15, color: theme.textSecondary, marginBottom: 10, fontFamily: fonts.bodyLight },
  ...
  confidenceText: { fontSize: 11.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
  ...
  overviewLabel: { fontSize: 11.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
  section: {
    backgroundColor: theme.bgCard, borderRadius: 16, padding: 16,
    marginBottom: 12, borderWidth: 1, borderColor: theme.border,
  },
  sectionTitle: { fontSize: 15, fontFamily: fonts.bodyBold, color: theme.textSecondary, marginBottom: 14 },
  ...
  setLabel: { fontSize: 12.8, color: theme.textMuted, marginTop: 4, fontFamily: fonts.bodyLight },
  setVs: { fontSize: 17.1, color: theme.textDim, fontFamily: fonts.bodyBold },
  ...
  styleValue: { fontSize: 15, fontFamily: fonts.bodyBold, color: theme.primary },
  ...
  dayText: { fontSize: 10.7, fontFamily: fonts.bodyBold, color: theme.textMuted },
  dayTextActive: { color: theme.primary },
  clubRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  clubRank: { fontSize: 13.9, fontFamily: fonts.bodyBold, color: theme.textDim, width: 24 },
