...
const styles = StyleSheet.create({
  ...
  platformInfo:           { flex: 1 },
  platformLabel:          { fontSize: 17.1, fontFamily: fonts.bodyBold, color: theme.textPrimary, marginBottom: 3 },
  platformStatus:         { fontSize: 12.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
  comingSoonBadge:        {
    backgroundColor: theme.bgDeep, borderRadius: 8,
    paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: theme.border,
  },
  comingSoonText:         { fontSize: 11.8, color: theme.textMuted, fontFamily: fonts.bodyBold },
  manualBadge:            {
  ...
  manualBadgeText:        { fontSize: 11.8, color: theme.primary, fontFamily: fonts.bodyBold },
  otcNote:                {
  ...
  otcNoteText:            { fontSize: 12.8, color: theme.textMuted, fontFamily: fonts.bodyLight },
