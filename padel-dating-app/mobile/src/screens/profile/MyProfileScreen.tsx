...
const styles = StyleSheet.create({
  ...
  profileCity: { fontSize: 13.9, color: theme.textMuted, marginBottom: 8, fontFamily: fonts.bodyLight },
  clubBadge: {
  ...
  clubBadgeName: { fontSize: 13.9, fontFamily: fonts.bodyBold, color: theme.primary },
  ...
  badgeText: { fontSize: 13.9, color: theme.textSecondary, fontFamily: fonts.bodyBold },
  ...
  statLabel: { fontSize: 11.8, color: theme.textMuted, fontFamily: fonts.bodyBold },
  ...
  syncCtaText: { flex: 1 },
  syncCtaTitle: { fontSize: 16.1, fontFamily: fonts.bodyBold, color: theme.primary, marginBottom: 3 },
  syncCtaTitleSynced: { fontSize: 16.1, fontFamily: fonts.bodyBold, color: theme.textPrimary, marginBottom: 3 },
