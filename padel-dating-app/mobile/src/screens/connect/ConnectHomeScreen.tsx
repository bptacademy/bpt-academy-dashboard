...
const styles = StyleSheet.create({
  ...
  sectionSub: { fontSize: 12.8, color: theme.textMuted, marginBottom: 16, lineHeight: 18, fontFamily: fonts.bodyLight },
  ...
  lockedSub: { fontSize: 15, color: theme.textSecondary, textAlign: 'center', lineHeight: 22, fontFamily: fonts.bodyLight },
  lockedBtn: {
