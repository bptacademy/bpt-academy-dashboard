...
const styles = StyleSheet.create({
  ...
  playerInitialsText: { fontFamily: fonts.bodyBold, color: '#0D1B2A', fontSize: 15 },
  scoreBadge: {
  ...
  mockBadgeText: { fontFamily: fonts.bodyLight, color: theme.textSecondary, fontSize: 11.8 },
  ...
  pillText: { fontSize: 15, fontFamily: fonts.bodyLight, color: theme.textSecondary },
  pillTextActive: { fontFamily: fonts.bodyBold, color: theme.primary },
  sliderContainer: { alignItems: 'center', gap: 10 },
  sliderLabel: { fontSize: 15, fontFamily: fonts.bodyBold, color: theme.textSecondary },
  ...
  errorText: { fontSize: 16.1, fontFamily: fonts.bodyLight, color: theme.textSecondary, textAlign: 'center', lineHeight: 22 },
});
...
const popup = StyleSheet.create({
  ...
  scoreLabel: { fontSize: 9.6, fontFamily: fonts.bodyBold, color: theme.primary, letterSpacing: 1 },
  ...
  city: { fontSize: 13.9, fontFamily: fonts.bodyLight, color: theme.textSecondary },
  ...
  statLabel: { fontSize: 11.8, fontFamily: fonts.bodyLight, color: theme.textSecondary },
  ...
  styleText: { fontFamily: fonts.bodyBold, color: theme.primary, fontSize: 12.8, textTransform: 'capitalize' },
  viewBtn: { width: '100%', backgroundColor: theme.primary, borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginTop: 8 },
  viewBtnText: { fontFamily: fonts.bodyBold, color: '#0D1B2A', fontSize: 17.1 },
  closeBtn: { paddingVertical: 10 },
  closeBtnText: { fontFamily: fonts.bodyLight, color: theme.textSecondary, fontSize: 15 },
});
