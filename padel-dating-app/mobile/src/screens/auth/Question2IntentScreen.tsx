...
const styles = StyleSheet.create({
  ...
  optionCardActive: { borderColor: '#E63F6B', backgroundColor: 'rgba(230,63,107,0.06)' },
  optionEmoji: { fontSize: 26, width: 36, textAlign: 'center' },
  optionText: { flex: 1 },
  optionLabel: { fontSize: 16, fontWeight: '700', color: '#FFFFFF', marginBottom: 2 },
  optionLabelActive: { color: '#E63F6B' },
  optionDesc: { fontSize: 13, color: '#4A6080' },
  radio: {
    width: 22, height: 22, borderRadius: 11,
    borderWidth: 2, borderColor: '#2A3C52',
    alignItems: 'center', justifyContent: 'center',
  },
  radioActive: { borderColor: '#E63F6B' },
  radioDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#E63F6B' },
