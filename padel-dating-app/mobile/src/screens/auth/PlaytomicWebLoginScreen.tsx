...
const styles = StyleSheet.create({
  ...
  closeBtnText: { color: theme.textSecondary, fontSize: 17.1, fontFamily: fonts.bodyBold },
  headerTitle: { fontSize: 17.1, fontFamily: fonts.bodyBold, color: theme.textPrimary },
  ...
  detectedSub: { fontSize: 16.1, color: theme.primary, fontFamily: fonts.bodyLight },
  ...
  unavailableText: { fontSize: 15, color: theme.textMuted, textAlign: 'center', lineHeight: 22, fontFamily: fonts.bodyLight },
  ...
  backBtnText: { color: theme.primary, fontFamily: fonts.bodyBold, fontSize: 16.1 },
  ...
  manualBackText: { color: theme.textSecondary, fontSize: 15, fontFamily: fonts.bodyLight },
  ...
  manualBody: { fontSize: 15, color: theme.textSecondary, lineHeight: 22, fontFamily: fonts.bodyLight },
  stepBox: {
  ...
  stepText: { flex: 1, fontSize: 15, color: theme.textSecondary, lineHeight: 20, fontFamily: fonts.bodyLight },
  ...
  manualInput: {
    ...
    fontSize: 21.4, color: theme.textPrimary, fontFamily: fonts.bodyBold, letterSpacing: 2,
  },
  manualPrimaryBtn: {
  ...
  manualSecondaryBtnText: { color: theme.textMuted, fontSize: 15, fontFamily: fonts.bodyLight },
});
