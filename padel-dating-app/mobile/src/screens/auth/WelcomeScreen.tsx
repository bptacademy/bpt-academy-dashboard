    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <Animated.View style={[styles.bottom, { opacity: fadeAnim }]}>
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text style={styles.primaryBtnText}>Connect with Playtomic</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={styles.secondaryBtnText}>Use a different platform</Text>
        </TouchableOpacity>
