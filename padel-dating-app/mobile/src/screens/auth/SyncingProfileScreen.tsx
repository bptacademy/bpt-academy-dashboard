...
const styles = StyleSheet.create({
  ...
  step: { fontSize: 16.1, color: theme.textMuted, textAlign: 'center', fontFamily: fonts.bodyLight },
  ...
  slowText: { fontSize: 13.9, color: theme.textMuted, textAlign: 'center', lineHeight: 20, fontFamily: fonts.bodyLight },
  skipBtn: {
    backgroundColor: theme.primaryDim, borderRadius: 10,
    paddingHorizontal: 20, paddingVertical: 10,
    borderWidth: 1, borderColor: theme.primaryBorder,
  },
  skipText: { color: theme.primary, fontSize: 15, fontFamily: fonts.bodyBold },
  footer: {
