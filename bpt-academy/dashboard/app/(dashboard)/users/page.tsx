...
export default function UsersPage() {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    const roles =
      tab === 'admin' ? ['admin', 'super_admin'] : [tab]
      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-72"
          />
        </div>
        <select
              ...
              {loading ? (
                ...
                filtered.map((user) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <span
                        className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium capitalize ${getRoleBadgeColor(
                          user.role
                        )}`}
                      >
                        {user.role.replace('_', ' ')}
