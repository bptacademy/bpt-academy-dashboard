...
--   super_admin > admin > coach > student/parent
-- =============================================

-- Step 1: Add new enum value (safe — Postgres allows adding to enums)
alter type user_role add value if not exists 'super_admin';

-- =============================================
-- Step 2: Update all RLS policies that check
-- for elevated roles to also include super_admin
-- =============================================
...
-- Super admin: can delete any profile (e.g. remove a user)
...
create policy "Admins can update settings"
  ...
  using (
    exists (
      ...
      -- Note: coaches intentionally excluded from settings management
    )
  );
...
-- =============================================
-- Step 3: Super Admin management helper
-- Only super_admin can promote/demote other users
-- (enforced in application layer + this policy)
-- =============================================

-- A function to safely assign roles
-- Only callable by super_admin (checked inside function)
