...
const styles = StyleSheet.create({
  ...
  bellBtn: { width: 64, height: 44, justifyContent: 'center', alignItems: 'center' },
  ...
  homeLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  avatar: { width: 46, height: 46, borderRadius: 23, borderWidth: 2, borderColor: '#16A34A' },
  avatarPlaceholder: { width: 46, height: 46, borderRadius: 23, backgroundColor: '#16A34A', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#22C55E' },
  ...
  rolePill: { borderWidth: 1, borderColor: 'rgba(255,255,255,0.35)', borderRadius: 12, paddingHorizontal: 10, paddingVertical: 4 },
