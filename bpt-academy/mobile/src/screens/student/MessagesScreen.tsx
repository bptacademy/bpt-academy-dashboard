...
const styles = StyleSheet.create({
  ...
  wrapper: { flex: 1, backgroundColor: '#0B1628' },
  container: { flex: 1 },
  ...
  sectionHint: { fontSize: 12, color: '#7A8FA6', marginBottom: 10 },
  ...
  cardUnread: { borderColor: 'rgba(251,191,36,0.40)', backgroundColor: 'rgba(251,191,36,0.08)' },

  folderCard: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(17,30,51,0.85)',
    borderRadius: 14, padding: 14, marginTop: 8,
    borderWidth: 1, borderColor: 'rgba(22,163,74,0.30)', gap: 12,
  },
  folderAvatar: { width: 48, height: 48, borderRadius: 14, backgroundColor: 'rgba(22,163,74,0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  badgeEmpty: { backgroundColor: 'rgba(255,255,255,0.10)', borderRadius: 10, paddingHorizontal: 8, paddingVertical: 2, minWidth: 22, alignItems: 'center' },
  badgeText: { fontSize: 12, fontWeight: '700', color: '#FFFFFF' },

  avatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(255,255,255,0.08)', alignItems: 'center', justifyContent: 'center' },
  avatarGroup: { backgroundColor: 'rgba(22,163,74,0.15)' },
  avatarDivision: { width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(251,191,36,0.15)', alignItems: 'center', justifyContent: 'center' },
  avatarAnnouncement: { width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(234,88,12,0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  convName: { fontSize: 15, fontWeight: '600', color: '#F0F6FC', flex: 1 },
  convNameUnread: { fontWeight: '700', color: '#FFFFFF' },
  time: { fontSize: 12, color: '#7A8FA6', marginLeft: 8 },
  lastMsg: { fontSize: 13, color: '#7A8FA6', marginTop: 3 },
  lastMsgEmpty: { fontSize: 13, color: '#4B6278', marginTop: 3, fontStyle: 'italic' },
  chevron: { fontSize: 20, color: '#4B6278', marginLeft: 4 },
  emptySection: { backgroundColor: 'rgba(17,30,51,0.85)', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', marginBottom: 10 },
  emptySectionText: { fontSize: 13, color: '#7A8FA6', lineHeight: 20 },
  fab: {
    position: 'absolute', bottom: 88, right: 24, width: 56, height: 56, borderRadius: 28,
