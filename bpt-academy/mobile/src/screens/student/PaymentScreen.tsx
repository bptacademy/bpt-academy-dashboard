...
const styles = StyleSheet.create({
  ...
  tabRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 10, padding: 4, marginBottom: 24 },
  tab: { flex: 1, paddingVertical: 11, borderRadius: 8, alignItems: 'center' },
  tabActive: { backgroundColor: 'rgba(59,130,246,0.25)', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 4, shadowOffset: { width: 0, height: 1 } },
  tabText: { fontSize: 14, fontWeight: '600', color: '#7A8FA6' },
  tabTextActive: { color: '#F0F6FC' },
  section: {},
  sectionTitle: { fontSize: 17, fontWeight: '700', color: '#F0F6FC', marginBottom: 8 },
  instructions: { fontSize: 13, color: '#7A8FA6', marginBottom: 16, lineHeight: 20 },
  ...
  bankCard: { backgroundColor: 'rgba(17,30,51,0.85)', borderRadius: 14, padding: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', marginBottom: 20 },
  bankRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.08)' },
  bankLabel: { fontSize: 13, color: '#7A8FA6', flex: 1 },
  bankValue: { fontSize: 14, fontWeight: '700', color: '#F0F6FC', flex: 2, textAlign: 'right' },
  ...
  fieldLabel: { fontSize: 13, fontWeight: '600', color: '#F0F6FC', marginBottom: 8 },
  input: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: '#F0F6FC', minHeight: 60, textAlignVertical: 'top', marginBottom: 20 },
