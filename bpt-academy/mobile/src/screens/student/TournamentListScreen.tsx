...
const styles = StyleSheet.create({
  ...
  loader: { marginTop: 60 },
  emptyCard: { margin: 20, backgroundColor: 'rgba(17,30,51,0.85)', borderRadius: 14, padding: 24, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)' },
  ...
  cardTitle: { fontSize: 16, fontWeight: '700', color: '#F0F6FC', flex: 1, marginRight: 10 },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
  statusText: { fontSize: 11, fontWeight: '700', color: '#FFFFFF', textTransform: 'capitalize' },
  meta: { fontSize: 13, color: '#7A8FA6', marginBottom: 4 },
