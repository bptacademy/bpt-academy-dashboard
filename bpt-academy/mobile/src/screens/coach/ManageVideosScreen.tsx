...
const styles = StyleSheet.create({
  ...
  addRow: { flexDirection: 'row', justifyContent: 'flex-end', padding: 12, backgroundColor: 'transparent', borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.10)' },
  ...
  tagText: { fontSize: 12, color: '#7A8FA6' },
  tagTextGreen: { color: '#16A34A' },
  date: { fontSize: 12, color: '#4B6278', marginBottom: 12 },
  actions: { flexDirection: 'row', gap: 10 },
  actionBtn: { flex: 1, borderRadius: 8, paddingVertical: 8, alignItems: 'center', borderWidth: 1 },
  actionBtnGreen: { borderColor: '#16A34A', backgroundColor: 'rgba(22,163,74,0.15)' },
  actionBtnGrey: { borderColor: 'rgba(255,255,255,0.15)', backgroundColor: 'rgba(255,255,255,0.05)' },
