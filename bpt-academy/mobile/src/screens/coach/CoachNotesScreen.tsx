...
const styles = StyleSheet.create({
  ...
  studentPanel: {
    width: 130, backgroundColor: 'rgba(11,22,40,0.92)', borderRightWidth: 1, borderRightColor: 'rgba(255,255,255,0.10)', paddingTop: 12,
  },
  panelTitle: { fontSize: 12, fontWeight: '700', color: '#4B6278', paddingHorizontal: 12, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  studentRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 10, gap: 8 },
  studentRowActive: { backgroundColor: 'rgba(59,130,246,0.15)' },
  studentAvatar: {
    width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.12)',
    alignItems: 'center', justifyContent: 'center',
  },
  studentAvatarText: { fontSize: 12, fontWeight: '700', color: '#CBD5E1' },
  studentName: { fontSize: 12, color: '#F0F6FC', flex: 1 },
  ...
  selectPromptText: { fontSize: 14, color: '#4B6278' },
  notesPanelHeader: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingHorizontal: 16, marginBottom: 12,
  },
  notesPanelTitle: { fontSize: 16, fontWeight: '700', color: '#F0F6FC', flex: 1 },
  ...
  emptyNotes: { textAlign: 'center', color: '#4B6278', marginTop: 20 },
  noteCard: {
    backgroundColor: 'rgba(17,30,51,0.85)', borderRadius: 12, padding: 14,
    borderWidth: 1, borderColor: '#E5E7EB',
  },
  noteCardPrivate: { borderColor: '#F59E0B', backgroundColor: 'rgba(245,158,11,0.12)' },
  ...
  noteText: { fontSize: 14, color: '#CBD5E1', lineHeight: 20, marginBottom: 10 },
  noteMeta: { fontSize: 11, color: '#4B6278' },
  modalOverlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0,0,0,0.4)' },
  modalCard: {
    backgroundColor: '#111E33', borderTopLeftRadius: 20, borderTopRightRadius: 20,
    padding: 24, paddingBottom: 40,
  },
  modalTitle: { fontSize: 17, fontWeight: '700', color: '#F0F6FC', marginBottom: 16 },
  modalInput: {
    backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)',
    padding: 14, fontSize: 14, color: '#F0F6FC', minHeight: 120, marginBottom: 16,
  },
  privateRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 },
  privateLabel: { fontSize: 14, color: '#CBD5E1' },
  modalBtns: { flexDirection: 'row', gap: 12 },
  modalCancelBtn: {
    flex: 1, borderRadius: 10, paddingVertical: 14, alignItems: 'center',
    borderWidth: 1, borderColor: '#E5E7EB',
  },
  modalCancelBtnText: { fontSize: 15, fontWeight: '600', color: '#CBD5E1' },
